...
# # %%
# # Sort alphabetically by key, then print key-value pairs
# for k, v in sorted(os.environ.items()): # Sorting the items by key
#     print(f"{k}={v}") # Printing key-value pairs in the required format
